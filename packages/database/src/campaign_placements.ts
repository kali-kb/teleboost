...
import { campaign_placement_status_enum } from "./enums/campaign_placement_status.js";
...
export const campaign_placements_relations = relations(campaign_placements, ({ one }) => ({
